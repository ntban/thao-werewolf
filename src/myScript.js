...
var ruleBlock = document.getElementById("ruleBlock");
ruleBlock.style.display = "block";

function showRule() {
  var ruleBlockTem = document.getElementById("ruleBlock");
  var characterBlock = document.getElementById("characterBlock");
  ruleBlockTem.style.display = "block";
  characterBlock.style.display = "none";
}
function showCharacter() {
  var ruleBlockTem = document.getElementById("ruleBlock");
  var characterBlock = document.getElementById("characterBlock");
  ruleBlockTem.style.display = "none";
